...
export const fallbackListings: Listing[] = [
  { id: 9, slug: "ashton-asoke-3br-42f", name: "Ashton Asoke · Rare 3 Bedroom", district: "Asoke", rent: 100000, bedrooms: 3, bathrooms: 3, sizeSqm: 100, floor: "42", stationType: "MRT", stationName: "Sukhumvit", walkMinutes: 1, latitude: 13.7386, longitude: 100.5605, image: "/properties/ashton-asoke/786342964_2664258444007827_8397648305202113964_n.jpg", status: "available", sourceUrl: "", lastVerified: "2026-08-31", description: "A one-of-a-kind 100 sq m three-bedroom, three-bathroom residence on the 42nd floor of Ashton Asoke. Curved floor-to-ceiling glass frames an unblocked panoramic city view, while the fully decorated interior comes complete with premium furnishings and electrical appliances." },
  ...
  { id: 4, slug: "supalai-icon-sathorn-1br", name: "Supalai ICON Sathorn · 1 Bedroom", district: "Sathorn", rent: 45000, bedrooms: 1, bathrooms: 1, sizeSqm: 46, floor: "High floor", stationType: "BTS", stationName: "Chong Nonsi", walkMinutes: 10, latitude: 13.7245, longitude: 100.5284, image: "/bangkok/hero-night.jpg", status: "verify", sourceUrl: "https://propertyhub.in.th/en/listings/for-rent-condo-supalai-icon-sathorn-mrt-si-lom-thungmahamek-sa-thon-bangkok-cx-113708-live-chat-with-us-add-line-connexproperty--a91009fa---4914124", lastVerified: "2026-08-13", description: "Move-in-ready city residence in Bangkok’s business district with premium facilities." },
...
export async function ensureListings(): Promise<void> {
  ...
  const listingsToSeed = (count?.count ?? 0) > 0
    ? fallbackListings.filter((listing) => ["centurion-park-ari-soi-5-1br", "baan-klang-krung-siam-2br", "ashton-asoke-3br-42f"].includes(listing.slug))
    : fallbackListings;
