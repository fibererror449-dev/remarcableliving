...
export default function SiteNav({ current, homeHref = "/" }: { current?: SiteSection; homeHref?: string }) {
  const [open, setOpen] = useState(false);
  return (
    <header className="site-nav">
      <a className="brand" href={homeHref} aria-label="REMARCABLE LIVING home" onClick={() => setOpen(false)}><BrandLogo /></a>
